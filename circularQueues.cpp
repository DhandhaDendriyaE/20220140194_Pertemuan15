...
class Queues {
	...
	int max = 5; ///< variable private ma untuk menyimpan ukuran maximum antrian
	int queue_array[5];

public:
	/**
	 * @brief Contruct a new Queues object
	 ...
	 * data dimasukin dalam variable queue_array
	 */
	void insert() {
    ...
    /**
     * @brief method utuk menghapus data dalam antrian
     * data disimpan dari dalam variable queue_array
     */
